...
class Board:
    ...
    def draw_static(self, surface):
        ...
        grid_width = (self.settings["cell_size"] + self.settings["grid_thickness"]) * self.settings["num_cols"]

        # preview grid
        preview_x = self.settings["board_x_pos"] + grid_width + self.settings["preview_gap_from_main_grid"]
