...
tetronimo_shapes = {
    ...
    Tetronimoes.S: np.array([[0, Tetronimoes.Z.value, Tetronimoes.Z.value], [Tetronimoes.Z.value, Tetronimoes.Z.value, 0], [0, 0, 0]]),
    Tetronimoes.Z: np.array([[Tetronimoes.S.value, Tetronimoes.S.value, 0], [0, Tetronimoes.S.value, Tetronimoes.S.value], [0, 0, 0]]),
